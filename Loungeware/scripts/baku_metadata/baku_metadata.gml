...
microgame_register("baku_puzzle", {
	config_version					: 1,
	game_name						: "Puzzle",
	authors							: "baku",
	prompt							: "SOLVE",
	init_room						: baku_puzzle_rm,
	view_width						: 480,
	view_height						: 320,
	time_seconds					: 12,
	music_track						: -1,
	...
	cartridge_col_primary			: "000000",
	cartridge_col_secondary			: "ffffff",
	cartridge_label					: baku_puzzle_spr_label,
	default_is_fail					: true,
	supports_difficulty_scaling		: true,
	credits							: [ "baku" ],
	date_added						: { day : 15, month : "December", year : 2021 },
	is_enabled						: true,
	supports_html					: true,
	show_on_website					: true,
	description						: [ "...a new case, huh?" ],
	how_to_play						: [ "solve the case, dummy" ],
});